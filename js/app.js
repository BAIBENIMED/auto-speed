                ...
                <div class="login-wrapper">
                    <div class="login-box glass">
                        <div class="login-logo" style="display: flex; justify-content: center; margin-bottom: 20px;">
                            <img src="assets/logo.svg" alt="TIBOU AUTO" style="height: 80px; width: auto;">
                        </div>
                ...
                <div class="view-header">
                    <div class="header-title-area">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            <h1><i class="fas fa-globe-americas"></i> Tracking Mondial</h1>
                            <span style="background: #ef4444; color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.7rem; font-weight: bold; animation: pulse 2s infinite;">ITINÉRAIRE VIA LE CAP ACTIF</span>
                        </div>
                        <p class="subtitle">Position en temps réel de la flotte maritime - Navigation Haute Mer</p>
                    </div>
                </div>
                <!-- Map Container -->
                <div class="glass" style="padding: 0; border-radius: 16px; height: calc(100vh - 180px); overflow: hidden; position: relative; min-height: 400px;">
    ...
    `;
        ...
        async handleShipmentSubmission(formData) {
            try {
                ...
                this.showToast("Erreur lors de l'enregistrement de l'expédition", "error");
            }
        },
